...
std::shared_ptr<DS::VolumeInfo>
DeviceStorageDataMgr::FindPrivateForEmulate(std::shared_ptr<DS::VolumeInfo> &vol)
{
    if (vol != nullptr) {
...
std::shared_ptr<DS::VolumeInfo>
DeviceStorageDataMgr::FindEmulateForPrivate(std::shared_ptr<DS::VolumeInfo> &vol)
{
    if (vol != nullptr) {
