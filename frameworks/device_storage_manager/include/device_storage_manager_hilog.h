...
#ifndef STORAGE_DISKMGR_FRAMEWORKS_DEVICE_STORAGE_MANAGER_HILOG_H
#define STORAGE_DISKMGR_FRAMEWORKS_DEVICE_STORAGE_MANAGER_HILOG_H

#include "hilog/log.h"
namespace OHOS {
static constexpr OHOS::HiviewDFX::HiLogLabel LOG_LABEL = { LOG_CORE, 0, "DeviceStorageManager" };
...
#endif // STORAGE_DISKMGR_FRAMEWORKS_DEVICE_STORAGE_MANAGER_HILOG_H
