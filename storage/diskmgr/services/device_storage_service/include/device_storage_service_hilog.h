...
#ifndef STORAGE_DISKMGR_SERVICES_DEVICE_STORAGE_SERVICES_HILOG_H
#define STORAGE_DISKMGR_SERVICES_DEVICE_STORAGE_SERVICES_HILOG_H

#include "hilog/log.h"
namespace OHOS {
static constexpr OHOS::HiviewDFX::HiLogLabel LOG_LABEL = { LOG_CORE, 0, "DeviceStorageService" };
